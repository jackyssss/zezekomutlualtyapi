/// kod emeğe saygıdan dolayı https://discord.gg/KsaJdrz     serenia squad sunucusundan alınmıştır
  ...
  .then(() => {
    ...
    .then((collected) => { 
      try {
        ...
        message.guild.createChannel(`Toplam Üye •
${message.guild.memberCount}`, 'voice').then(channel => channel.setParent(message.guild.channels.find(channel => channel.name === `${client.user.username} • Sunucu Panel`))).then(c => {
...
exports.help = {
  name: 'sunucupanel',
  description: 'Sunucu istatistiklerini gösteren panel kurarve otomatik olarak günceller.',
  usage: 'sunucupanel',
  kategori: 'yetkili'
};